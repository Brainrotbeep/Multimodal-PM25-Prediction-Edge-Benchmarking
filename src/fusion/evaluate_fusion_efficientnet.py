...
print("Fusion EfficientNet + Transformer Model Loaded")
...
print("\n" + "=" * 50)
print("Fusion EfficientNet + Transformer Evaluation")
print("=" * 50)
...
save_metrics(
    ...
    model_name="fusion_efficientnet_transformer"
)
